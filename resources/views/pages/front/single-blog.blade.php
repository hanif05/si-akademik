                                ...
                                <div class="single-comment justify-content-between d-flex">
                                    <div class="user justify-content-between d-flex">
                                        ...
                                        <div class="desc">
                                            ...
                                            @endif
                                            <p class="date">{{ $item->created_at->format('F d, Y') }} at {{ $item->created_at->format('h:i a') }} </p>
                                            <p class="comment">
                                                {{ $item->content }}
                                            </p>
                                        </div>
                ...
                <div class="comment-form">
                    ...
                    <form action="{{ route('comments.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <textarea class="form-control mb-10" rows="5" placeholder="Your Comment"
                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Comment'" name="content" required=""></textarea>
                        </div>
